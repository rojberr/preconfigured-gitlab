...
terraform apply
```
, and enjoy your newly created AWS EC2 GitLab server ;) The IP will be randomly generated and printed in the console output.
...
3) To destroy you EC2 instance execute:
```bash
terraform destroy
```
... and type: "yes".

Destroy and deploy your GitLab instance only when needed to reduce the costs ;)
